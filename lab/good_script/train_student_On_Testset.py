...
print("paramters's setting: CLASS_NUM:{}, COMMON_REPRESENTATION_SIZE:{}, HIDDEN_LAYER:{}, MAX_EPOCH:{},"
      ...
      "LR:{}, transforms_bridge_RL:{},beta1:{}, TEST_LR:{}"
      .format(CLASS_NUM, COMMON_REPRESENTATION_SIZE, HIDDEN_LAYER, MAX_EPOCH, TEST_TRAINING_EPOCH
              , BATCH_SIZE, TRANSFERBRIDGE_BATCH_SIZE, TEST_BATCH_SIZE, LR, transforms_bridge_RL,
               beta1, TEST_LR))
print("log_interval:{}, save_interval{}, test_flag:{}, val_interval:{}, epoch_begin_test:{}"
      .format(log_interval, save_interval, test_flag, val_interval, epoch_begin_test))
...
for i in range(len(featureSet_list)):
    transferBridge_optimizer_set.append(optim.Adam(transferBridge_set[i].parameters(), lr=transforms_bridge_RL, betas=(beta1, 0.999)))
...
for epoch in range(MAX_EPOCH):
    ...
    if test_flag and (epoch > epoch_begin_test):
        ...
        for batch_idx, data in enumerate(test_dataloader):
            ...
            for converge in range(TEST_TRAINING_EPOCH):
                ...
                writer.add_scalar("Test Loss", test_loss, iter_count+epoch*TEST_TRAINING_EPOCH*10)
        ...
        print(" Loss: {:.4f} Acc:{:.2%}".format(test_loss, correct / total))
    ...
    if (epoch + 1) % save_interval == 0:
        ...
        torch.save(student_net, model_saved_path)
