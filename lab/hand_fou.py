...
from tools.datasets import fou_Dataset
...
# file_name = 'mfeat-fou'#train:94%;test:86%
# file_name = 'mfeat-fac'#train:99%;test:98%
# file_name = 'mfeat-kar'#train:99%;test:96%
# file_name = 'mfeat-pix'#train:99%;test:98%
# file_name = 'mfeat-zer'#train:90%;test:87%
file_name = 'mfeat-mor'#train:76%;test:75%
...
train_data = fou_Dataset(data_path=train_file_path)
test_data = fou_Dataset(data_path=test_file_path, train=False)

train_loader = torch.utils.data.DataLoader(dataset=train_data, batch_size=BATCH_SIZE, shuffle=True)
test_loader = torch.utils.data.DataLoader(dataset=test_data, batch_size=BATCH_SIZE, shuffle=False)
# ============================ step 2/5 model ============================
print("the feature size is {}".format(train_data.get_features_size()))
net = MLP(classes=CLASS, input_size=train_data.get_features_size())
net.to(device)
...
# ============================ step 4/5 optimizer ============================
# optimizer = optim.SGD(net.parameters(), lr=LR, momentum=0.9, weight_decay=1e-2)  # 选择优化器
