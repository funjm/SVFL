...
model_epoch = sys.argv[1]


print("paramters's setting: CLASS_NUM:{}, COMMON_REPRESENTATION_SIZE:{}, HIDDEN_LAYER:{}, "
      "TEST_TRAINING_EPOCH:{}, TRANSFERBRIDGE_BATCH_SIZE:{}, TEST_BATCH_SIZE:{}, "
      "beta1:{}, TEST_LR:{}, model_epoch:{}, if_adam:{}, if_shuffle:{}"
      .format(CLASS_NUM, COMMON_REPRESENTATION_SIZE, HIDDEN_LAYER,  TEST_TRAINING_EPOCH, TRANSFERBRIDGE_BATCH_SIZE
              , TEST_BATCH_SIZE, beta1, TEST_LR, model_epoch, if_adam, if_shuffle))
...
test_dataloader = torch.utils.data.DataLoader(dataset=testdataset, batch_size=TEST_BATCH_SIZE, shuffle=if_shuffle)
...
for batch_idx, data in enumerate(test_dataloader):
    ...
    print(" totoal Loss: {:.4f} test_Acc:{:.2%}".format(test_loss, correct / total))
